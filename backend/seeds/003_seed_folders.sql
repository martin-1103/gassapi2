-- Seed: Folders Table
-- Description: Insert sample API folders for development environment
...
DELETE FROM folders WHERE name LIKE 'Demo %' OR name LIKE 'Sample %';
