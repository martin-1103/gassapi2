...
export const authApi = {
  ...
  logout: () => apiClient.post<ApiResponse>(buildQuery('logout')),

  logoutAll: () => apiClient.post<ApiResponse>(buildQuery('logout_all')),

  refresh: (refreshToken: string) =>
    apiClient.post<ApiResponse<AuthResponse>>(buildQuery('refresh'), {
...
export const profileApi = {
  get: () => apiClient.get<ApiResponse<User>>(buildQuery('profile')),
...
export const projectsApi = {
  list: () => apiClient.get<ApiResponse<Project[]>>(buildQuery('projects')),
...
export const collectionsApi = {
  list: (projectId: string) =>
    apiClient.get<ApiResponse<Collection[]>>(
      buildQuery('collections_list', projectId),
    ),
  ...
  create: (
    ...
    apiClient.post<ApiResponse<Collection>>(
      buildQuery('collection_create', projectId),
      data,
    ),
  ...
  update: (id: string, data: Partial<Collection>) =>
    apiClient.put<ApiResponse<Collection>>(
      buildQuery('collection_update', id),
      data,
    ),
...
export const endpointsApi = {
  list: (collectionId: string) =>
    apiClient.get<ApiResponse<Endpoint[]>>(
      buildQuery('endpoints_list', collectionId),
    ),
  ...
  create: (
    ...
    apiClient.post<ApiResponse<Endpoint>>(
      buildQuery('endpoint_create', collectionId),
      data,
    ),
  ...
  update: (id: string, data: Partial<Endpoint>) =>
    apiClient.put<ApiResponse<Endpoint>>(
      buildQuery('endpoint_update', id),
      data,
    ),
...
export const environmentsApi = {
  list: (projectId: string) =>
    apiClient.get<ApiResponse<Environment[]>>(
      buildQuery('environments_list', projectId),
    ),
  ...
  create: (
    ...
    apiClient.post<ApiResponse<Environment>>(
      buildQuery('environment_create', projectId),
      data,
    ),

  get: (id: string) =>
    apiClient.get<ApiResponse<Environment>>(
      buildQuery('environment_detail', id),
    ),

  update: (id: string, data: Partial<Environment>) =>
    apiClient.put<ApiResponse<Environment>>(
      buildQuery('environment_update', id),
      data,
    ),
...
export const flowsApi = {
  ...
  listActive: (projectId: string) =>
    apiClient.get<ApiResponse<Flow[]>>(
      buildQuery('flows_active_list', projectId),
    ),
  ...
  create: (
    ...
    apiClient.post<ApiResponse<Flow>>(
      buildQuery('flow_create', projectId),
      data,
    ),
