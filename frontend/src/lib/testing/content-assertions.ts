...
export interface IContentAssertions {
  ...
  // Type Assertions
  toBeInstanceOf(expectedClass: any, message?: string): AssertionResult;
...
export class ContentAssertions implements IContentAssertions {
  ...
  toEqual(expected: any, message?: string): AssertionResult {
    ...
    return addAssertion(this.context, 'to equal', {
      expected,
      actual: this.actual,
      passed
    }, assertionMessage);
  ...
  toBeNull(message?: string): AssertionResult {
    ...
    return addAssertion(this.context, 'to be null', {
      expected: null,
      actual: this.actual,
      passed
    }, assertionMessage);
  ...
  toBeUndefined(message?: string): AssertionResult {
    ...
    return addAssertion(this.context, 'to be undefined', {
      expected: undefined,
      actual: this.actual,
      passed
    }, assertionMessage);
  ...
  toBeTruthy(message?: string): AssertionResult {
    ...
    return addAssertion(this.context, 'to be truthy', {
      expected: true,
      actual: this.actual,
      passed
    }, assertionMessage);
  ...
  toBeFalsy(message?: string): AssertionResult {
    ...
    return addAssertion(this.context, 'to be falsy', {
      expected: false,
      actual: this.actual,
      passed
    }, assertionMessage);
  ...
  toInclude(expected: string, message?: string): AssertionResult {
    ...
    return addAssertion(this.context, 'to include', {
      expected,
      actual: this.actual,
      passed
    }, assertionMessage);
  ...
  toNotInclude(expected: string, message?: string): AssertionResult {
    ...
    return addAssertion(this.context, 'to not include', {
      expected,
      actual: this.actual,
      passed
    }, assertionMessage);
  ...
  toMatch(pattern: string | RegExp, message?: string): AssertionResult {
    ...
    return addAssertion(this.context, 'to match', {
      expected: pattern,
      actual: this.actual,
      passed
    }, assertionMessage);
  ...
  toHaveLength(expected: number, message?: string): AssertionResult {
    ...
    return addAssertion(this.context, 'to have length', {
      expected,
      actual: actualLength,
      passed
    }, assertionMessage);
  ...
  toBeInstanceOf(expectedClass: any, message?: string): AssertionResult {
    ...
    return addAssertion(this.context, 'to be instance', {
  ...
  toBeArray(message?: string): AssertionResult {
    ...
    return addAssertion(this.context, 'to be array', {
      expected: 'Array',
  ...
  toMatchType(expectedType: string, message?: string): AssertionResult {
    ...
    return addAssertion(this.context, 'to match type', {
  ...
  // Convenience Methods
  success(message?: string): AssertionResult {
    return addAssertion(this.context, 'test passed', {
      passed: true
    }, message || 'Test passed');
  }

  failure(message?: string): AssertionResult {
    return addAssertion(this.context, 'test failed', {
      passed: false
    }, message || 'Test failed');
  }
}
