...
// Import utilities
import { generateCodeSnippets, RequestData } from "./utils/template-utils"
import { getFileExtension } from "./utils/language-configs"
...
export function CodeGeneratorModal({
  ...
  // Download code
  const downloadCode = (code: string, language: string, extension: string) => {
