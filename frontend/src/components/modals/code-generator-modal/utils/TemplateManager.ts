...
import { generateJavaScriptFetch, generateJavaScriptAxios } from './javascript-templates'
import { generatePythonRequests, generatePythonHttpx } from './python-templates'
