...
export const COMMON_HEADERS = [
  ...
  },
  {
    key: 'Accept',
    value: 'application/json',
    description: 'Media types yang dapat diterima',
  },
  {
    key: 'Authorization',
    value: 'Bearer {{token}}',
...
export const HEADER_PRESETS = {
  ...
  'File Upload': [{ key: 'Content-Type', value: 'multipart/form-data' }],
  WebSocket: [
...
export const copyHeadersToClipboard = async (
  ...
  try {
    ...
    logger.error('Failed to copy headers', error as Error, 'header-utils');
    return false;
  }
};
