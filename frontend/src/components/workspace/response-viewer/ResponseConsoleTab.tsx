...
export default function ResponseConsoleTab({ console }: ResponseConsoleTabProps) {
  ...
  const groupedLogs = filterConsole.reduce((acc, entry) => {
          ...
          <div className="space-y-2">
            {filterConsole.length === 0 ? (
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p className="text-sm">
                  No console output was recorded during this request. 
                  Use console.log() in your test scripts to see output here.
                </p>
              </div>
            ) : (
              <div className="space-y-2">
                {filterConsole.map((entry, index) => (
                  <div 
                    ...
                    className={`p-3 rounded-lg border ${
                      ...
                      entry.level === 'error' ? 'border-red-200 bg-red-50' :
                      entry.level === 'debug' ? 'border-purple-200 bg-purple-50' :
