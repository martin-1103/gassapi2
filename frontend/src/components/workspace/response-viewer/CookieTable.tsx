            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                {(() => {
                  ...
                  if (security.icon === 'shield') {
                    return <Shield className={`w-4 h-4 ${security.className}`} />
                  } else {
              ...
              <div className="mb-2">
                <Input
                  ...
                  onChange={(e) => onSetEditCookie({ ...editCookie, value: e.target.value })}
                  disabled={!editMode}
            ...
            <div className="flex items-center gap-1">
              {editMode ? (
                ...
                <>
                  ...
                  <Button size="sm" variant="ghost" onClick={() => onDeleteCookie(cookie.name)}>
