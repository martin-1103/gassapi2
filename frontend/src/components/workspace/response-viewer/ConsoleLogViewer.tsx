  ...
  if (filteredEntries.length === 0) {
    return (
      <div className='text-center py-8 text-muted-foreground'>
        ...
        <p className='text-sm'>
          No console output was recorded during this request. Use console.log()
          in your test scripts to see output here.
        </p>
      </div>
    );
  }
          ...
          >
            <div className='flex items-start gap-3'>
              <div className={`mt-0.5 ${getLevelColorClass(entry.level)}`}>
                {(() => {
                  const IconComponent =
                    CONSOLE_ICONS[entry.level as keyof typeof CONSOLE_ICONS];
